...
def deploy_dbt_project(gcs_bucket_path: str) -> dict:
    ...
    Args:
        gcs_bucket_path (str): A GCS URL (starting with "gs://") pointing to the root of the dbt project folder.

    Returns:
        dict: A dictionary containing:
            - "deployment_status" (str): Status of the deployment ("success" or error message).
            - "deployed_path" (str or None): Local path where the project was deployed, or None on failure.
    """
    try:
